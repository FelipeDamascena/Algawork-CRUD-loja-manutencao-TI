...
public class OrdemServico {
	...
	private OffsetDateTime dateAbertura;
	...
	public OffsetDateTime getDateAbertura() {
		return dateAbertura;
	}

	public void setDateAbertura(OffsetDateTime dateAbertura) {
	...
	setDateFinalizacao(OffsetDateTime.now());
